...
<body>
	...
	<div class="form-style-10">
		...
		<form action="control/updateStock" method="post">
			...
			<div class="inner-wrap">
				...
				<label>Quantity <input id="quantity" type="number" name="quantity" style="width:50%" ></input></label>
				
				<label>Price <input id="price" type="number" name="price" style="width:50%"></input></label>
			</div>
